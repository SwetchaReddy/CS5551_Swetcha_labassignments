package com.Lab10.SwetchaReddy.Watch.MainActivity;
...
public class MainActivity extends Activity
{
    ...
    public void searchText(View v) {
        ...
        String data = "https://kgsearch.googleapis.com/v1/entities:search?" + "query=" + searchString + "&" + "key= AIzaSyCpL2b78RNUjVvsDbjZUteI0WianeRxqYY" + "&" + "indent=true" + "&" + "languages=en" + "&" + "limit=3";
